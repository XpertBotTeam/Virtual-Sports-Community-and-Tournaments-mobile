...
class _PlayerBoxState extends State<PlayerBox> {
  ...
  openEditPlayerDialog() async {
    showDialog(
        context: context,
        builder: (context) => EditPlayerBottomSheet(widget.player,
            db: db, refreshSquad: widget.refreshSquad));
  }
          ...
          child: Column(
            children: [
              widget.player.starterImage == null
                  ...
                  : CircleAvatar(
                      backgroundImage:
                          FileImage(File(widget.player.starterImage!)),
                      radius: boxWidth / 2,
                    ),
              ...
              if (widget.player.backupName != null &&
